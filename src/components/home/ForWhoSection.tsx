      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            {personas.map((persona, index) => (
              <div
                key={persona.label}
                className={cn(
                  "w-[calc(50%-6px)] sm:w-[calc(33.333%-8px)] md:w-[calc(25%-9px)] group flex items-center gap-3 p-4 rounded-2xl bg-white border border-border/60 shadow-sm hover:border-gold/40 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-default",
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-gold/10 to-gold/5 flex items-center justify-center group-hover:from-gold/20 group-hover:to-gold/10 transition-all flex-shrink-0">
                  <persona.icon className="w-5 h-5 text-gold transition-colors" />
                </div>
          ...
          <div
            ref={cardRef}
            className={cn(
              "relative rounded-2xl p-8 md:p-10 overflow-hidden transition-all duration-700 ease-out",
              "bg-gradient-to-br from-navy to-navy/90 text-white shadow-[0_20px_60px_-10px_rgba(28,42,58,0.4)]",
          ...
          >
            ...
            <div className="absolute -right-16 -top-16 w-64 h-64 bg-gold/8 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute -left-8 -bottom-8 w-48 h-48 bg-sky/8 rounded-full blur-3xl pointer-events-none" />

            <p className="text-lg md:text-xl text-white/90 leading-relaxed relative">
              DoCourse este făcut pentru profesioniștii care vor să livreze cursuri online{" "}
              <span className="font-semibold text-gold">fără să se piardă în tehnic</span>.
              Fără Drive, foldere, linkuri împrăștiate și cursanți confuzi.
            </p>
            <p className="text-lg md:text-xl text-white/90 leading-relaxed mt-4 relative">
